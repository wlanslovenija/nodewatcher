...
urlpatterns = [
    ...
    urls.url(
        r'^password/change/$',
        decorators.authenticated_required(function=auth_views.password_change),
        {
    ...
    urls.url(
        ...
        decorators.authenticated_required(function=auth_views.password_change_done),
        name='auth_password_change_done',
    ),
    urls.url(
        r'^password/reset/$',
        decorators.anonymous_required(function=auth_views.password_reset),
        {
    ...
    urls.url(
        ...
        decorators.anonymous_required(function=auth_views.password_reset_confirm),
        {
    ...
    urls.url(
        ...
        decorators.anonymous_required(function=auth_views.password_reset_complete),
        name='auth_password_reset_complete',
    ),
    urls.url(
        r'^password/reset/done/$',
        decorators.anonymous_required(function=auth_views.password_reset_done),
