...
urlpatterns = urls.patterns('',
    ...
    urls.url(r'^node/(?P<node>[^/]+)$', 'nodewatcher.nodes.views.node_display', name = 'view_node'),

    # Node manipulation
    urls.url(r'^node/(?P<node>[^/]+)/edit$', 'nodewatcher.nodes.views.node_edit', name = 'edit_node'),
