...
urlpatterns = patterns('',
  ...
  url(r'^nodes/deallocate_subnet/(?P<subnet_id>\d+)$', 'wlanlj.nodes.views.node_deallocate_subnet', name = 'remove_subnet'),
  url(r'^nodes/edit_subnet/(?P<subnet_id>\d+)$', 'wlanlj.nodes.views.node_edit_subnet', name = 'edit_subnet'),
  ...
  url(r'^nodes/events/(?P<node>.*?)$', 'wlanlj.nodes.views.node_events', name = 'view_node_events'),
