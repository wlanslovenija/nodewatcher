...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SystemStatusMonitor.uptime'
        db.alter_column('core_systemstatusmonitor', 'uptime', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SystemStatusMonitor.local_time'
        db.alter_column('core_systemstatusmonitor', 'local_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SystemStatusMonitor.uptime'
        raise RuntimeError("Cannot reverse this migration. 'SystemStatusMonitor.uptime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SystemStatusMonitor.local_time'
        raise RuntimeError("Cannot reverse this migration. 'SystemStatusMonitor.local_time' and its values cannot be restored.")
