...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'GeneralConfig.type'
        raise RuntimeError("Cannot reverse this migration. 'GeneralConfig.type' and its values cannot be restored.")
