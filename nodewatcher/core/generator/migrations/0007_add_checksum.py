...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildResultFile.checksum_md5'
        db.add_column(u'generator_buildresultfile', 'checksum_md5',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'BuildResultFile.checksum_sha256'
        db.add_column(u'generator_buildresultfile', 'checksum_sha256',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildResultFile.checksum_md5'
        db.delete_column(u'generator_buildresultfile', 'checksum_md5')

        # Deleting field 'BuildResultFile.checksum_sha256'
        db.delete_column(u'generator_buildresultfile', 'checksum_sha256')
    ...
    models = {
        ...
        u'generator.buildresultfile': {
            'Meta': {'object_name': 'BuildResultFile'},
            'checksum_md5': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'checksum_sha256': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '200'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['generator.BuildResult']"}),
            'uuid': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'})
        },
