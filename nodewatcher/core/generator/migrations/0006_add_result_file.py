...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuildResultFile'
        db.create_table(u'generator_buildresultfile', (
            ('uuid', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['generator.BuildResult'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=200)),
        ))
        db.send_create_signal(u'generator', ['BuildResultFile'])


    def backwards(self, orm):
        # Deleting model 'BuildResultFile'
        db.delete_table(u'generator_buildresultfile')
