...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildResult.build_log'
        db.add_column(u'generator_buildresult', 'build_log',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildResult.build_log'
        db.delete_column(u'generator_buildresult', 'build_log')
