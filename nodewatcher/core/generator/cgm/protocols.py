...
class IEEE80211A(WirelessProtocol):
    ...
    channels = (
        ...
        Channel("ch50", 50, 5250),
        Channel("ch52", 52, 5260),
        Channel("ch54", 54, 5270),
        Channel("ch56", 56, 5280),
        Channel("ch58", 58, 5290),
        Channel("ch60", 60, 5300),
        Channel("ch62", 62, 5310),
        Channel("ch64", 64, 5320),
        Channel("ch100", 100, 5500),
        Channel("ch102", 102, 5510),
        Channel("ch104", 104, 5520),
        Channel("ch106", 106, 5530),
        Channel("ch108", 108, 5540),
        Channel("ch110", 110, 5550),
        Channel("ch112", 112, 5560),
        Channel("ch114", 114, 5570),
        Channel("ch116", 116, 5580),
        Channel("ch118", 118, 5590),
        Channel("ch120", 120, 5600),
        Channel("ch122", 122, 5610),
        Channel("ch124", 124, 5620),
        Channel("ch126", 126, 5630),
        Channel("ch128", 128, 5640),
        Channel("ch132", 132, 5660),
        Channel("ch134", 134, 5670),
        Channel("ch136", 136, 5680),
        Channel("ch138", 138, 5690),
        Channel("ch140", 140, 5700),
        Channel("ch142", 142, 5710),
        Channel("ch144", 144, 5720),
        Channel("ch149", 149, 5745),
        Channel("ch151", 151, 5755),
        Channel("ch153", 153, 5765),
        Channel("ch155", 155, 5775),
        Channel("ch157", 157, 5785),
        Channel("ch159", 159, 5795),
        Channel("ch161", 161, 5805),
        Channel("ch165", 165, 5825),
    )
    widths = (
        ChannelWidth("nw5", _("5 MHz"), 5),
        ChannelWidth("nw10", _("10 MHz"), 10),
