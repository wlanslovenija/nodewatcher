...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InterfaceLimitConfig.root'
        db.alter_column('cgm_interfacelimitconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

        # Changing field 'AuthenticationConfig.root'
        db.alter_column('cgm_authenticationconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

        # Changing field 'PackageConfig.root'
        db.alter_column('cgm_packageconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

        # Changing field 'InterfaceConfig.root'
        db.alter_column('cgm_interfaceconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

        # Changing field 'NetworkConfig.root'
        db.alter_column('cgm_networkconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

    def backwards(self, orm):

        # Changing field 'InterfaceLimitConfig.root'
        db.alter_column('cgm_interfacelimitconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))

        # Changing field 'AuthenticationConfig.root'
        db.alter_column('cgm_authenticationconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))

        # Changing field 'PackageConfig.root'
        db.alter_column('cgm_packageconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))

        # Changing field 'InterfaceConfig.root'
        db.alter_column('cgm_interfaceconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))

        # Changing field 'NetworkConfig.root'
        db.alter_column('cgm_networkconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))
    ...
    models = {
        ...
        'cgm.authenticationconfig': {
            ...
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'config_cgm_authenticationconfig'", 'to': "orm['core.Node']"})
        },
        ...
        'cgm.interfacelimitconfig': {
            ...
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'config_cgm_interfacelimitconfig'", 'to': "orm['core.Node']"})
        },
        'cgm.networkconfig': {
            ...
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'config_cgm_networkconfig'", 'to': "orm['core.Node']"})
        },
        'cgm.packageconfig': {
