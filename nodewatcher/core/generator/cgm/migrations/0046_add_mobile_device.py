...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobileInterfaceConfig'
        db.create_table(u'cgm_mobileinterfaceconfig', (
            ...
            ('service', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='umts', max_length=50, regpoint='node.config', enum_id='core.interfaces#mobile_service')),
            ('device', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='mobile0', max_length=50, regpoint='node.config', enum_id='core.interfaces#mobile_device')),
            ('apn', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'cgm', ['MobileInterfaceConfig'])


    def backwards(self, orm):
        # Deleting model 'MobileInterfaceConfig'
        db.delete_table(u'cgm_mobileinterfaceconfig')
