...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('core', '0045_polymorphic'),
    )

    def forwards(self, orm):
        db.rename_column('cgm_authenticationconfig', 'content_type_id', 'polymorphic_ctype_id')
        db.rename_column('cgm_interfaceconfig', 'content_type_id', 'polymorphic_ctype_id')
        db.rename_column('cgm_interfacelimitconfig', 'content_type_id', 'polymorphic_ctype_id')
        db.rename_column('cgm_networkconfig', 'content_type_id', 'polymorphic_ctype_id')
        db.rename_column('cgm_packageconfig', 'content_type_id', 'polymorphic_ctype_id')
    ...
    models = {
        ...
        'cgm.authenticationconfig': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_cgm.authenticationconfig_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
        ...
        'cgm.interfacelimitconfig': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_cgm.interfacelimitconfig_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
        ...
        'cgm.networkconfig': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_cgm.networkconfig_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
