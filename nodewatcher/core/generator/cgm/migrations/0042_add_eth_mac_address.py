...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EthernetInterfaceConfig.mac_address'
        db.add_column(u'cgm_ethernetinterfaceconfig', 'mac_address',
                      self.gf('nodewatcher.core.registry.fields.MACAddressField')(max_length=17, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EthernetInterfaceConfig.mac_address'
        db.delete_column(u'cgm_ethernetinterfaceconfig', 'mac_address')
