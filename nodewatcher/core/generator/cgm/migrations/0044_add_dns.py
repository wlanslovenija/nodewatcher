...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DnsServerConfig'
        db.create_table(u'cgm_dnsserverconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_cgm.dnsserverconfig_set', null=True, to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'config_cgm_dnsserverconfig', to=orm['core.Node'])),
            ('address', self.gf('nodewatcher.core.registry.fields.IPAddressField')(host_required=True)),
        ))
        db.send_create_signal(u'cgm', ['DnsServerConfig'])


    def backwards(self, orm):
        # Deleting model 'DnsServerConfig'
        db.delete_table(u'cgm_dnsserverconfig')
