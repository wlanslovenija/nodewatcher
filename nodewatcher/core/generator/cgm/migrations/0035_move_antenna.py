...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("core", "0036_move_antenna"),
    )

    def forwards(self, orm):

        # Changing field 'WifiRadioDeviceConfig.antenna'
        db.alter_column('cgm_wifiradiodeviceconfig', 'antenna_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['antennas.Antenna'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'WifiRadioDeviceConfig.antenna'
        db.alter_column('cgm_wifiradiodeviceconfig', 'antenna_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True, on_delete=models.PROTECT))
