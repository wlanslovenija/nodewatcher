...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cgm_cgmgeneralconfig', 'version_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['generator.BuildVersion'], null=True, on_delete=models.SET_NULL))

        # Changing field 'CgmGeneralConfig.build_channel'
        db.alter_column(u'cgm_cgmgeneralconfig', 'build_channel_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['generator.BuildChannel'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'CgmGeneralConfig.version'
        db.alter_column(u'cgm_cgmgeneralconfig', 'version_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['generator.BuildVersion'], null=True, on_delete=models.PROTECT))

        # Changing field 'CgmGeneralConfig.build_channel'
        db.alter_column(u'cgm_cgmgeneralconfig', 'build_channel_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['generator.BuildChannel'], null=True, on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'cgm.cgmgeneralconfig': {
            ...
            'build_channel': ('nodewatcher.core.registry.fields.ModelSelectorKeyField', [], {'to': u"orm['generator.BuildChannel']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'version': ('nodewatcher.core.registry.fields.ModelSelectorKeyField', [], {'to': u"orm['generator.BuildVersion']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
