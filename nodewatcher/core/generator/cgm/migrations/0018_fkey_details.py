...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_wifiinterfaceconfig', 'antenna_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True, on_delete=models.PROTECT))
        ...
        db.alter_column('cgm_wifinetworkconfig', 'pool_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool'], on_delete=models.PROTECT))
        ...
        db.alter_column('cgm_allocatednetworkconfig', 'pool_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool'], on_delete=models.PROTECT))
    def backwards(self, orm):

        # Changing field 'WifiInterfaceConfig.antenna'
        db.alter_column('cgm_wifiinterfaceconfig', 'antenna_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True))
        ...
        # Changing field 'WifiNetworkConfig.pool'
        db.alter_column('cgm_wifinetworkconfig', 'pool_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool']))
        ...
        # Changing field 'AllocatedNetworkConfig.pool'
        db.alter_column('cgm_allocatednetworkconfig', 'pool_id', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool']))
    models = {
        'auth.group': {
