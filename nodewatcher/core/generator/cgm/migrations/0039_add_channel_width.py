...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WifiRadioDeviceConfig.channel_width'
        db.add_column('cgm_wifiradiodeviceconfig', 'channel_width',
                      self.gf('django.db.models.fields.CharField')(default='ht20', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WifiRadioDeviceConfig.channel_width'
        db.delete_column('cgm_wifiradiodeviceconfig', 'channel_width')
