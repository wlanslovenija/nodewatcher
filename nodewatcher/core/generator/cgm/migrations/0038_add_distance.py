...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_cgmgeneralconfig', 'version', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#version'))
        # Adding field 'WifiRadioDeviceConfig.ack_distance'
        db.add_column('cgm_wifiradiodeviceconfig', 'ack_distance',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WifiRadioDeviceConfig.ack_distance'
        db.delete_column('cgm_wifiradiodeviceconfig', 'ack_distance')
    ...
    models = {
        ...
        'cgm.wifiradiodeviceconfig': {
            ...
            'ack_distance': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
