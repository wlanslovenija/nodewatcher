...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('monitor_interfacemonitor', 'rx_packets', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.rx_bytes'
        db.alter_column('monitor_interfacemonitor', 'rx_bytes', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.tx_errors'
        db.alter_column('monitor_interfacemonitor', 'tx_errors', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.tx_packets'
        db.alter_column('monitor_interfacemonitor', 'tx_packets', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.tx_drops'
        db.alter_column('monitor_interfacemonitor', 'tx_drops', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.rx_errors'
        db.alter_column('monitor_interfacemonitor', 'rx_errors', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.tx_bytes'
        db.alter_column('monitor_interfacemonitor', 'tx_bytes', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

        # Changing field 'InterfaceMonitor.rx_drops'
        db.alter_column('monitor_interfacemonitor', 'rx_drops', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=0))

    def backwards(self, orm):

        # Changing field 'InterfaceMonitor.rx_packets'
        db.alter_column('monitor_interfacemonitor', 'rx_packets', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.rx_bytes'
        db.alter_column('monitor_interfacemonitor', 'rx_bytes', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.tx_errors'
        db.alter_column('monitor_interfacemonitor', 'tx_errors', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.tx_packets'
        db.alter_column('monitor_interfacemonitor', 'tx_packets', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.tx_drops'
        db.alter_column('monitor_interfacemonitor', 'tx_drops', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.rx_errors'
        db.alter_column('monitor_interfacemonitor', 'rx_errors', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.tx_bytes'
        db.alter_column('monitor_interfacemonitor', 'tx_bytes', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'InterfaceMonitor.rx_drops'
        db.alter_column('monitor_interfacemonitor', 'rx_drops', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        ...
        'monitor.interfacemonitor': {
            ...
            'rx_bytes': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'rx_drops': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'rx_errors': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'rx_packets': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'tx_bytes': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'tx_drops': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'tx_errors': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'}),
            'tx_packets': ('django.db.models.fields.DecimalField', [], {'max_digits': '100', 'decimal_places': '0'})
        },
