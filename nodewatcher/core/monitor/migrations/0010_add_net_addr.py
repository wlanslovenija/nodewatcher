...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NetworkAddressMonitor'
        db.create_table('monitor_networkaddressmonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitoring_monitor_networkaddressmonitor', to=orm['core.Node'])),
            ('interface', self.gf('nodewatcher.core.registry.fields.IntraRegistryForeignKey')(related_name='networks', to=orm['monitor.InterfaceMonitor'])),
            ...
            ('address', self.gf('nodewatcher.core.registry.fields.IPAddressField')(null=True)),
        ))
        db.send_create_signal('monitor', ['NetworkAddressMonitor'])


    def backwards(self, orm):
        # Deleting model 'NetworkAddressMonitor'
        db.delete_table('monitor_networkaddressmonitor')
