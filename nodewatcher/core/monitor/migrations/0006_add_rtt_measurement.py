...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RttMeasurementMonitor'
        db.create_table('monitor_rttmeasurementmonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitoring_monitor_rttmeasurementmonitor', to=orm['core.Node'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node'], null=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('packet_size', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('packet_loss', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('all_packets', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('successful_packets', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('failed_packets', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('rtt_minimum', self.gf('django.db.models.fields.FloatField')()),
            ('rtt_average', self.gf('django.db.models.fields.FloatField')()),
            ('rtt_maximum', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('monitor', ['RttMeasurementMonitor'])


    def backwards(self, orm):
        # Deleting model 'RttMeasurementMonitor'
        db.delete_table('monitor_rttmeasurementmonitor')
    ...
    models = {
        ...
        'monitor.rttmeasurementmonitor': {
            ...
            'all_packets': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'end': ('django.db.models.fields.DateTimeField', [], {}),
            'failed_packets': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'packet_loss': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'packet_size': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'monitoring_monitor_rttmeasurementmonitor'", 'to': "orm['core.Node']"}),
            'rtt_average': ('django.db.models.fields.FloatField', [], {}),
            'rtt_maximum': ('django.db.models.fields.FloatField', [], {}),
            'rtt_minimum': ('django.db.models.fields.FloatField', [], {}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Node']", 'null': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'successful_packets': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
