...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monitor_wifiinterfacemonitor', (
            ...
            ('channel', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('channel_width', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('bitrate', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('rts_threshold', self.gf('django.db.models.fields.IntegerField')()),
            ('frag_threshold', self.gf('django.db.models.fields.IntegerField')()),
            ('signal', self.gf('django.db.models.fields.IntegerField')()),
            ('noise', self.gf('django.db.models.fields.IntegerField')()),
