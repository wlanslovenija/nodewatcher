...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoutingAnnounceMonitor.status'
        db.alter_column('monitor_routingannouncemonitor', 'status', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.monitoring', enum_id='network.routing.announces#status'))

        # Changing field 'RoutingAnnounceMonitor.last_seen'
        db.alter_column('monitor_routingannouncemonitor', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'TopologyLink.last_seen'
        db.alter_column('monitor_topologylink', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RoutingAnnounceMonitor.status'
        raise RuntimeError("Cannot reverse this migration. 'RoutingAnnounceMonitor.status' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RoutingAnnounceMonitor.status'
        db.alter_column('monitor_routingannouncemonitor', 'status', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.monitoring', enum_id='network.routing.announces#status'))

        # User chose to not deal with backwards NULL issues for 'RoutingAnnounceMonitor.last_seen'
        raise RuntimeError("Cannot reverse this migration. 'RoutingAnnounceMonitor.last_seen' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RoutingAnnounceMonitor.last_seen'
        db.alter_column('monitor_routingannouncemonitor', 'last_seen', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'TopologyLink.last_seen'
        raise RuntimeError("Cannot reverse this migration. 'TopologyLink.last_seen' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TopologyLink.last_seen'
        db.alter_column('monitor_topologylink', 'last_seen', self.gf('django.db.models.fields.DateTimeField')())
