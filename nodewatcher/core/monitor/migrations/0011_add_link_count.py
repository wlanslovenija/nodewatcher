...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoutingTopologyMonitor.link_count'
        db.add_column('monitor_routingtopologymonitor', 'link_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoutingTopologyMonitor.link_count'
        db.delete_column('monitor_routingtopologymonitor', 'link_count')
