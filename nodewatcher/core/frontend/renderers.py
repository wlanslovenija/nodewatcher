...
from . import add_css_class, text_value, get_theme_setting
...
class BaseRenderer(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.horizontal_label_class = kwargs.get(
            'horizontal_label_class', get_theme_setting(
                'horizontal_label_class')
        )
        self.horizontal_field_class = kwargs.get(
            'horizontal_field_class', get_theme_setting(
...
class FieldRenderer(BaseRenderer):
    ...
    def __init__(self, field, *args, **kwargs):
        ...
        self.addon_before = kwargs.get(
            'addon_before', self.initial_attrs.pop('addon_before', ''))
        self.addon_after = kwargs.get(
            'addon_after', self.initial_attrs.pop('addon_after', ''))
        ...
        if error_css_class:
            ...
            self.error_css_class = getattr(
                ...
                get_theme_setting('error_css_class'))
