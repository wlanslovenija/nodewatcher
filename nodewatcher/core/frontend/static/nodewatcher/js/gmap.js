...
function createIcon(status) {
    ...
    icon.image = "/static/nodewatcher/images/status_" + status + "_gmap.png";
    icon.shadow = "/static/nodewatcher/images/gmap_node_shadow.png";
    icon.transparent = "/static/nodewatcher/images/gmap_node_transparent.png";
