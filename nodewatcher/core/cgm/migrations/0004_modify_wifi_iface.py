...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_cgmgeneralconfig', 'platform', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#platform', blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CgmGeneralConfig.platform'
        db.alter_column('cgm_cgmgeneralconfig', 'platform', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#platform'))
