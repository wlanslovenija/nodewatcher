...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cgm_vpnnetworkconfig', (
            ...
            ('address', self.gf('nodewatcher.core.registry.fields.IPAddressField')(host_required=True)),
        ...
        db.add_column('cgm_vpninterfaceconfig', 'protocol',
                      self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='tunneldigger', max_length=50, regpoint='node.config', enum_id='core.interfaces#vpn_protocol'),
                      keep_default=False)


        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#vpn_protocol'))
    def backwards(self, orm):
        ...
        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.servers.vpn#protocol'))
    models = {
