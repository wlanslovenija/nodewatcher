...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VpnNetworkConfig'
        db.create_table('cgm_vpnnetworkconfig', (
            ...
            ('address', self.gf('nodewatcher.registry.fields.IPAddressField')(host_required=True)),
            ('port', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cgm', ['VpnNetworkConfig'])

        # Adding field 'VpnInterfaceConfig.protocol'
        db.add_column('cgm_vpninterfaceconfig', 'protocol',
                      self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='tunneldigger', max_length=50, regpoint='node.config', enum_id='core.interfaces#vpn_protocol'),
                      keep_default=False)


        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#vpn_protocol'))
    def backwards(self, orm):
        # Deleting model 'VpnNetworkConfig'
        db.delete_table('cgm_vpnnetworkconfig')

        # Deleting field 'VpnInterfaceConfig.protocol'
        db.delete_column('cgm_vpninterfaceconfig', 'protocol')


        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.servers.vpn#protocol'))
    models = {
