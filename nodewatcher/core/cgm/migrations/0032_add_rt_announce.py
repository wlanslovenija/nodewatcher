...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_allocatednetworkconfig', 'routing_announce',
                      self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces.network#routing_announce', blank=True),
                      keep_default=False)
