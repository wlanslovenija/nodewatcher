...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AllocatedNetworkConfig.routing_announce'
        db.add_column('cgm_allocatednetworkconfig', 'routing_announce',
                      self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces.network#routing_announce', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AllocatedNetworkConfig.routing_announce'
        db.delete_column('cgm_allocatednetworkconfig', 'routing_announce')
