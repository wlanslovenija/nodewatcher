...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cgm_interfacelimitconfig', (
            ...
            ('interface', self.gf('nodewatcher.registry.fields.IntraRegistryForeignKey')(related_name='limits', to=orm['cgm.InterfaceConfig'])),
        ...
        db.create_table('cgm_throughputinterfacelimitconfig', (
            ...
            ('limit_out', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
            ('limit_in', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.add_column('cgm_interfaceconfig', 'limit_in', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)

        # Adding field 'InterfaceConfig.limit_out'
        db.add_column('cgm_interfaceconfig', 'limit_out', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)
    ...
    models = {
        ...
        'cgm.wifiinterfaceconfig': {
            ...
            'antenna': ('nodewatcher.registry.fields.ModelSelectorKeyField', [], {'to': "orm['core.Antenna']", 'null': 'True'}),
