...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cgm_interfacelimitconfig', (
            ...
            ('interface', self.gf('nodewatcher.core.registry.fields.IntraRegistryForeignKey')(related_name='limits', to=orm['cgm.InterfaceConfig'])),
        ...
        db.create_table('cgm_throughputinterfacelimitconfig', (
            ...
            ('limit_out', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
            ('limit_in', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.add_column('cgm_interfaceconfig', 'limit_in', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)

        # Adding field 'InterfaceConfig.limit_out'
        db.add_column('cgm_interfaceconfig', 'limit_out', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)
