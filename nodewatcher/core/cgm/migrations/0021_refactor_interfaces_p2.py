...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AllocatedNetworkConfig.usage'
        db.delete_column('cgm_allocatednetworkconfig', 'usage')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WifiNetworkConfig.usage'
        raise RuntimeError("Cannot reverse this migration. 'WifiNetworkConfig.usage' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AllocatedNetworkConfig.usage'
        raise RuntimeError("Cannot reverse this migration. 'AllocatedNetworkConfig.usage' and its values cannot be restored.")
    models = {
