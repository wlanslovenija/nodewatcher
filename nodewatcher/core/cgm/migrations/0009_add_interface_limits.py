...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CgmInterfaceConfig.limit_in'
        db.add_column('cgm_cgminterfaceconfig', 'limit_in', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)

        # Adding field 'CgmInterfaceConfig.limit_out'
        db.add_column('cgm_cgminterfaceconfig', 'limit_out', self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CgmInterfaceConfig.limit_in'
        db.delete_column('cgm_cgminterfaceconfig', 'limit_in')

        # Deleting field 'CgmInterfaceConfig.limit_out'
        db.delete_column('cgm_cgminterfaceconfig', 'limit_out')
    ...
    models = {
        ...
        'cgm.cgminterfaceconfig': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit_in': ('nodewatcher.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#traffic_limits'", 'blank': 'True'}),
            'limit_out': ('nodewatcher.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#traffic_limits'", 'blank': 'True'}),
        ...
        'cgm.dhcpnetworkconfig': {
            'Meta': {'object_name': 'DHCPNetworkConfig', '_ormbases': ['cgm.CgmNetworkConfig']},
            'cgmnetworkconfig_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cgm.CgmNetworkConfig']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'cgm.vpninterfaceconfig': {
            'Meta': {'object_name': 'VpnInterfaceConfig', '_ormbases': ['cgm.CgmInterfaceConfig']},
            'cgminterfaceconfig_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cgm.CgmInterfaceConfig']", 'unique': 'True', 'primary_key': 'True'}),
