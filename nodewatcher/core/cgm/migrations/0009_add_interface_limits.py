...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_cgminterfaceconfig', 'limit_in', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)

        # Adding field 'CgmInterfaceConfig.limit_out'
        db.add_column('cgm_cgminterfaceconfig', 'limit_out', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)
    ...
    models = {
        ...
        'cgm.cgminterfaceconfig': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit_in': ('nodewatcher.core.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#traffic_limits'", 'blank': 'True'}),
            'limit_out': ('nodewatcher.core.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#traffic_limits'", 'blank': 'True'}),
