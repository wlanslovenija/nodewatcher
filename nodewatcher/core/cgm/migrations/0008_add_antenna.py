...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_wifiinterfaceconfig', 'antenna', self.gf('nodewatcher.core.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True), keep_default=False)
