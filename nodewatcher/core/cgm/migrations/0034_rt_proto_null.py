...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_wifiinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'VpnInterfaceConfig.routing_protocol'
        db.alter_column('cgm_vpninterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'EthernetInterfaceConfig.routing_protocol'
        db.alter_column('cgm_ethernetinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))
    def backwards(self, orm):

        # Changing field 'WifiInterfaceConfig.routing_protocol'
        db.alter_column('cgm_wifiinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'VpnInterfaceConfig.routing_protocol'
        db.alter_column('cgm_vpninterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'EthernetInterfaceConfig.routing_protocol'
        db.alter_column('cgm_ethernetinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))
    models = {
