...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WifiInterfaceConfig.routing_protocol'
        db.alter_column('cgm_wifiinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'VpnInterfaceConfig.routing_protocol'
        db.alter_column('cgm_vpninterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'EthernetInterfaceConfig.routing_protocol'
        db.alter_column('cgm_ethernetinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, null=True, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))
    def backwards(self, orm):

        # Changing field 'WifiInterfaceConfig.routing_protocol'
        db.alter_column('cgm_wifiinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'VpnInterfaceConfig.routing_protocol'
        db.alter_column('cgm_vpninterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))

        # Changing field 'EthernetInterfaceConfig.routing_protocol'
        db.alter_column('cgm_ethernetinterfaceconfig', 'routing_protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'))
    models = {
        'cgm.allocatednetworkconfig': {
            ...
            'routing_announce': ('nodewatcher.registry.fields.SelectorKeyField', [], {'max_length': '50', 'null': 'True', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces.network#routing_announce'", 'blank': 'True'}),
        ...
        'cgm.ethernetinterfaceconfig': {
            ...
            'routing_protocol': ('nodewatcher.registry.fields.SelectorKeyField', [], {'max_length': '50', 'null': 'True', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#routing_protocol'", 'blank': 'True'}),
        ...
        'cgm.vpninterfaceconfig': {
            ...
            'protocol': ('nodewatcher.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#vpn_protocol'"}),
            'routing_protocol': ('nodewatcher.registry.fields.SelectorKeyField', [], {'max_length': '50', 'null': 'True', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces#routing_protocol'", 'blank': 'True'})
        },
        'cgm.vpnnetworkconfig': {
            'Meta': {'ordering': "['id']", 'object_name': 'VpnNetworkConfig', '_ormbases': ['cgm.NetworkConfig']},
            'address': ('nodewatcher.registry.fields.IPAddressField', [], {'host_required': 'True'}),
            'networkconfig_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cgm.NetworkConfig']", 'unique': 'True', 'primary_key': 'True'}),
