...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_wifiinterfaceconfig', 'routing_protocol',
                      self.gf('nodewatcher.registry.fields.SelectorKeyField')(default='none', max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.vpn.server#protocol'))
    models = {
        ...
        'cgm.vpnserverconfig': {
            ...
            'protocol': ('nodewatcher.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.servers.vpn#protocol'"}),
