...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WifiInterfaceConfig.routing_protocol'
        db.add_column('cgm_wifiinterfaceconfig', 'routing_protocol',
                      self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(default='none', max_length=50, regpoint='node.config', enum_id='core.interfaces#routing_protocol'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'WifiInterfaceConfig.routing_protocol'
        db.delete_column('cgm_wifiinterfaceconfig', 'routing_protocol')


        # Changing field 'VpnServerConfig.protocol'
        db.alter_column('cgm_vpnserverconfig', 'protocol', self.gf('nodewatcher.core.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.vpn.server#protocol'))
    models = {
        ...
        'cgm.vpnserverconfig': {
            ...
            'protocol': ('nodewatcher.core.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.servers.vpn#protocol'"}),
