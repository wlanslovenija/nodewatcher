...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CgmSolarPackageConfig'
        db.create_table('solar_cgmsolarpackageconfig', (
        ...
        db.send_create_signal('solar', ['CgmSolarPackageConfig'])


    def backwards(self, orm):

        # Deleting model 'CgmSolarPackageConfig'
        db.delete_table('solar_cgmsolarpackageconfig')
