...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('projects_projectconfig', 'content_type_id', 'polymorphic_ctype_id')
    ...
    models = {
        ...
        'projects.projectconfig': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_projects.projectconfig_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
