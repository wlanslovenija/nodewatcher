...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectConfig.root'
        db.alter_column('projects_projectconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Node']))

    def backwards(self, orm):

        # Changing field 'ProjectConfig.root'
        db.alter_column('projects_projectconfig', 'root_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodes.Node']))
    ...
    models = {
        ...
        'projects.projectconfig': {
            ...
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'config_projects_projectconfig'", 'to': "orm['core.Node']"})
        }
    }
