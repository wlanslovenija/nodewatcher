...
from . import models as dns_models, signals


class DnsServerConfigForm(forms.ModelForm):
    class Meta:
        model = dns_models.DnsServerConfig
        fields = '__all__'
...
registration.register_form_for_item(dns_models.DnsServerConfig, DnsServerConfigForm)
