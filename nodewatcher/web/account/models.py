...
class UserProfileAndSettings(django_models.Model):
  ...
  phone_number = phonenumber_fields.PhoneNumberField(_('phone number'), help_text=_('Please enter your phone number for use in emergency. It will be visible only to network administrators.'))
