...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_routingannouncemonitor', (
            ...
            ('network', self.gf('web.registry.fields.IPAddressField')()),
            ('status', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.monitoring', enum_id='network.routing.announces#status')),
        ))
    ...
    models = {
        ...
        'core.projectconfig': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('web.registry.fields.ModelSelectorKeyField', [], {'to': "orm['nodes.Project']", 'on_delete': 'models.PROTECT'}),
