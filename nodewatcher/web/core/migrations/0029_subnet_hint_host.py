...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_basicaddressingconfig', 'subnet_hint', self.gf('web.registry.fields.IPAddressField')(host_required=True, null=True))
    def backwards(self, orm):

        # Changing field 'BasicAddressingConfig.subnet_hint'
        db.alter_column('core_basicaddressingconfig', 'subnet_hint', self.gf('web.registry.fields.IPAddressField')(null=True))
    models = {
        'auth.group': {
