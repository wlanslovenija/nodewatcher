...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_cgmgeneralconfig', 'platform', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#platform', blank=True))
        ...
        db.alter_column('cgm_cgmgeneralconfig', 'router', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#router', blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CgmGeneralConfig.platform'
        db.alter_column('cgm_cgmgeneralconfig', 'platform', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#platform'))

        # Changing field 'CgmGeneralConfig.version'
        db.alter_column('cgm_cgmgeneralconfig', 'version', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'CgmGeneralConfig.router'
        db.alter_column('cgm_cgmgeneralconfig', 'router', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.general#router'))
