...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_staticnetworkconfig', 'gateway', self.gf('web.registry.fields.IPAddressField')(default='127.0.0.2', host_required=True), keep_default=False)

        # Adding field 'StaticNetworkConfig.address'
        db.add_column('cgm_staticnetworkconfig', 'address', self.gf('web.registry.fields.IPAddressField')(default='127.0.0.1/8', subnet_required=True), keep_default=False)
