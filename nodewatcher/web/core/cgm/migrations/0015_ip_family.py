...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cgm_staticnetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#ip_family'))

        # Changing field 'WifiNetworkConfig.family'
        db.alter_column('cgm_wifinetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#ip_family'))

        # Changing field 'AllocatedNetworkConfig.family'
        db.alter_column('cgm_allocatednetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#ip_family'))


    def backwards(self, orm):
        
        # Changing field 'StaticNetworkConfig.family'
        db.alter_column('cgm_staticnetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#family'))

        # Changing field 'WifiNetworkConfig.family'
        db.alter_column('cgm_wifinetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#family'))

        # Changing field 'AllocatedNetworkConfig.family'
        db.alter_column('cgm_allocatednetworkconfig', 'family', self.gf('web.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.config', enum_id='core.interfaces.network#family'))
