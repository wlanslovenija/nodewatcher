...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_generalconfig', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'GeneralConfig.type'
        db.add_column('core_generalconfig', 'type', self.gf('frontend.registry.fields.SelectorKeyField')(default='wireless', max_length=50, regpoint='node.config', enum_id='core.general#type'), keep_default=False)
