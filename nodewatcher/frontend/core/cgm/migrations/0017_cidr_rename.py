...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AllocatedNetworkConfig.cidr'
        db.rename_column('cgm_allocatednetworkconfig', 'cidr', 'prefix_length')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AllocatedNetworkConfig.cidr'
        db.rename_column('cgm_allocatednetworkconfig', 'prefix_length', 'cidr')
