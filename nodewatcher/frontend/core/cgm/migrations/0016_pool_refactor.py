...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WifiNetworkConfig.allocation'
        db.add_column('cgm_wifinetworkconfig', 'allocation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='allocations_cgm_wifinetworkconfig', null=True, to=orm['core.IpPool']), keep_default=False)

        # Adding field 'AllocatedNetworkConfig.allocation'
        db.add_column('cgm_allocatednetworkconfig', 'allocation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='allocations_cgm_allocatednetworkconfig', null=True, to=orm['core.IpPool']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WifiNetworkConfig.allocation'
        db.delete_column('cgm_wifinetworkconfig', 'allocation_id')

        # Deleting field 'AllocatedNetworkConfig.allocation'
        db.delete_column('cgm_allocatednetworkconfig', 'allocation_id')
