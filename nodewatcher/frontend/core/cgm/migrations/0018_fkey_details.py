...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WifiInterfaceConfig.antenna'
        db.alter_column('cgm_wifiinterfaceconfig', 'antenna_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True, on_delete=models.PROTECT))

        # Changing field 'WifiNetworkConfig.allocation'
        db.alter_column('cgm_wifinetworkconfig', 'allocation_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['core.IpPool']))

        # Changing field 'WifiNetworkConfig.pool'
        db.alter_column('cgm_wifinetworkconfig', 'pool_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool'], on_delete=models.PROTECT))

        # Changing field 'AllocatedNetworkConfig.allocation'
        db.alter_column('cgm_allocatednetworkconfig', 'allocation_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['core.IpPool']))

        # Changing field 'AllocatedNetworkConfig.pool'
        db.alter_column('cgm_allocatednetworkconfig', 'pool_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool'], on_delete=models.PROTECT))
    def backwards(self, orm):

        # Changing field 'WifiInterfaceConfig.antenna'
        db.alter_column('cgm_wifiinterfaceconfig', 'antenna_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.Antenna'], null=True))

        # Changing field 'WifiNetworkConfig.allocation'
        db.alter_column('cgm_wifinetworkconfig', 'allocation_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.IpPool']))

        # Changing field 'WifiNetworkConfig.pool'
        db.alter_column('cgm_wifinetworkconfig', 'pool_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool']))

        # Changing field 'AllocatedNetworkConfig.allocation'
        db.alter_column('cgm_allocatednetworkconfig', 'allocation_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.IpPool']))

        # Changing field 'AllocatedNetworkConfig.pool'
        db.alter_column('cgm_allocatednetworkconfig', 'pool_id', self.gf('frontend.registry.fields.ModelSelectorKeyField')(to=orm['core.IpPool']))
    models = {
        'auth.group': {
        ...
        'cgm.allocatednetworkconfig': {
            ...
            'family': ('frontend.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces.network#ip_family'"}),
            'networkconfig_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cgm.NetworkConfig']", 'unique': 'True', 'primary_key': 'True'}),
            'pool': ('frontend.registry.fields.ModelSelectorKeyField', [], {'to': "orm['core.IpPool']", 'on_delete': 'models.PROTECT'}),
        ...
        'cgm.interfacelimitconfig': {
            ...
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interface': ('frontend.registry.fields.IntraRegistryForeignKey', [], {'related_name': "'limits'", 'to': "orm['cgm.InterfaceConfig']"}),
        ...
        'cgm.throughputinterfacelimitconfig': {
            ...
            'limit_in': ('frontend.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces.limits#speeds'", 'blank': 'True'}),
            'limit_out': ('frontend.registry.fields.SelectorKeyField', [], {'default': "''", 'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces.limits#speeds'", 'blank': 'True'})
        },
        ...
        'cgm.wifiinterfaceconfig': {
            ...
            'antenna': ('frontend.registry.fields.ModelSelectorKeyField', [], {'to': "orm['core.Antenna']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
