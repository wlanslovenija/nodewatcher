...
AUTHENTICATION_BACKENDS = (
  'frontend.account.auth.NodewatcherBackend',
...
INSTALLED_APPS = (
  ...
  'frontend.core',
  'frontend.core.cgm',
  'frontend.core.cgm.packages.solar',
  'frontend.core.cgm.packages.digitemp',
  'frontend.routing_olsr',
  'frontend.telemetry_http',
  'frontend.telemetry_core',
  'guardian',
  'south',
)
...
MONITOR_PROCESSORS = (
  'frontend.routing_olsr.processors.OLSRTopology',
  'frontend.routing_olsr.processors.OLSRNodePostprocess',
  'frontend.telemetry_http.processors.HTTPTelemetry',
  'frontend.telemetry_core.processors.SystemStatusCheck',
  'frontend.monitor.processors.PurgeInvalidNodes'
)
...
REGISTRY_FORM_PROCESSORS = {
  'node.config' : [
    'frontend.core.allocation.processors.AutoPoolAllocator',
    'frontend.core.cgm.processors.NodeCgmValidator',
  ]
}
