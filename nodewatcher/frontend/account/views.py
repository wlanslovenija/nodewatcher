...
from frontend.account import signals
...
def logout_redirect(request, *args, **kwargs):
  ...
  A wrapper (which prefers redirects) around `django.contrib.auth.views.logout` view which sends a `frontend.account.signals.user_logout` signal on logout.
  """
...
def login(request, *args, **kwargs):
  ...
  A wrapper around `django.contrib.auth.views.login` view which sends a `frontend.acount.signals.user_login` signal on successful login.
  """
