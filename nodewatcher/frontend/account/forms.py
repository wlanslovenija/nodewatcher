...
from frontend.account import metaforms
from frontend.account import models
from frontend.account import validators
...
class AccountRegistrationForm(metaforms.FieldsetFormMixin, metaforms.ParentsIncludedModelFormMixin, UserCreationForm, UserProfileAndSettingsChangeForm):
  """
  This class defines combined form for `django.contrib.auth.models.User` and `frontend.account.models.UserProfileAndSettings` objects.
  ...
  def save(self, commit=True):
    # We disable save method as registration module (through `frontend.account.regbackend.ProfileBackend` backend) takes
...
class AccountChangeForm(metaforms.FieldsetFormMixin, metaforms.ParentsIncludedModelFormMixin, UserChangeForm, UserProfileAndSettingsChangeForm):
  """
  This class defines combined change form for `django.contrib.auth.models.User` and `frontend.account.models.UserProfileAndSettings` objects.
  """
