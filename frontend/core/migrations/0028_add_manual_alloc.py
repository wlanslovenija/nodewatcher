...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasicAddressingConfig.subnet_hint'
        db.add_column('core_basicaddressingconfig', 'subnet_hint',
                      self.gf('frontend.registry.fields.IPAddressField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BasicAddressingConfig.subnet_hint'
        db.delete_column('core_basicaddressingconfig', 'subnet_hint')
    ...
    models = {
        ...
        'core.basicaddressingconfig': {
            ...
            'subnet_hint': ('frontend.registry.fields.IPAddressField', [], {'null': 'True'}),
