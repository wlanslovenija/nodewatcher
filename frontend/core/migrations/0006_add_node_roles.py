...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('core', ['BorderRouterRoleConfig'])

        # Adding model 'VpnServerRoleConfig'
        db.create_table('core_vpnserverroleconfig', (
            ('roleconfig_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.RoleConfig'], unique=True, primary_key=True)),
            ('vpn_server', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('core', ['VpnServerRoleConfig'])

        # Adding model 'SystemRoleConfig'
        db.create_table('core_systemroleconfig', (
            ('roleconfig_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.RoleConfig'], unique=True, primary_key=True)),
            ('system', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('core', ['SystemRoleConfig'])

        # Adding model 'RoleConfig'
        db.create_table('core_roleconfig', (
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='config_core_roleconfig', to=orm['nodes.Node'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VpnServerRoleConfig'
        db.delete_table('core_vpnserverroleconfig')

        # Deleting model 'SystemRoleConfig'
        db.delete_table('core_systemroleconfig')
