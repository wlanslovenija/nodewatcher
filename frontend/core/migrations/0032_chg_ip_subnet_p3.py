...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IpPool.ip_subnet'
        db.delete_column('core_ippool', 'ip_subnet')
        # Renaming field 'ip_subnet_2' to 'ip_subnet'
        db.rename_column('core_ippool', 'ip_subnet_2', 'ip_subnet')

    def backwards(self, orm):
        # Renaming field 'ip_subnet' to 'ip_subnet_2'
        db.rename_column('core_ippool', 'ip_subnet', 'ip_subnet_2')
        # Adding field 'IpPool.ip_subnet'
        db.add_column('core_ippool', 'ip_subnet',
                      self.gf('django.db.models.fields.CharField')(null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'core.basicaddressingconfig': {
            ...
            'subnet_hint': ('frontend.registry.fields.IPAddressField', [], {'host_required': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'core.ippool': {
            ...
            'family': ('frontend.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.interfaces.network#ip_family'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_subnet_2': ('frontend.registry.fields.IPAddressField', [], {'null': 'True'}),
