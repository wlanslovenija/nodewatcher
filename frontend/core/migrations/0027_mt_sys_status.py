...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SystemStatusMonitor'
        db.create_table('core_systemstatusmonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitoring_core_systemstatusmonitor', to=orm['nodes.Node'])),
            ('uptime', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('local_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['SystemStatusMonitor'])

    def backwards(self, orm):
        # Deleting model 'SystemStatusMonitor'
        db.delete_table('core_systemstatusmonitor')
