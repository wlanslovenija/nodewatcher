...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_antenna', (
            ...
            ('polarization', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('angle_horizontal', self.gf('django.db.models.fields.IntegerField')(default=360)),
            ('angle_vertical', self.gf('django.db.models.fields.IntegerField')(default=360)),
