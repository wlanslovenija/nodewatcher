...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoutingAnnounceMonitor'
        db.create_table('core_routingannouncemonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monitoring_core_routingannouncemonitor', to=orm['nodes.Node'])),
            ('network', self.gf('frontend.registry.fields.IPAddressField')()),
            ('status', self.gf('frontend.registry.fields.SelectorKeyField')(max_length=50, regpoint='node.monitoring', enum_id='network.routing.announces#status')),
        ))
        db.send_create_signal('core', ['RoutingAnnounceMonitor'])

    def backwards(self, orm):
        # Deleting model 'RoutingAnnounceMonitor'
        db.delete_table('core_routingannouncemonitor')
    ...
    models = {
        ...
        'core.projectconfig': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('frontend.registry.fields.ModelSelectorKeyField', [], {'to': "orm['nodes.Project']", 'on_delete': 'models.PROTECT'}),
        ...
        'core.routeridconfig': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'family': ('frontend.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.config'", 'enum_id': "'core.routerid#family'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.routingannouncemonitor': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'network': ('frontend.registry.fields.IPAddressField', [], {}),
            'root': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'monitoring_core_routingannouncemonitor'", 'to': "orm['nodes.Node']"}),
            'status': ('frontend.registry.fields.SelectorKeyField', [], {'max_length': '50', 'regpoint': "'node.monitoring'", 'enum_id': "'network.routing.announces#status'"})
        },
