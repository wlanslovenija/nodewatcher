...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cgm_wifinetworkconfig', 'family', self.gf('frontend.registry.fields.SelectorKeyField')(default='ipv4', max_length=50, regpoint='node.config', enum_id='core.interfaces.network#family'), keep_default=False)

        # Adding field 'WifiNetworkConfig.usage'
        db.add_column('cgm_wifinetworkconfig', 'usage', self.gf('frontend.registry.fields.SelectorKeyField')(default='auto', max_length=50, regpoint='node.config', enum_id='core.interfaces.network#usage'), keep_default=False)

        # Adding field 'WifiNetworkConfig.cidr'
        db.add_column('cgm_wifinetworkconfig', 'cidr', self.gf('django.db.models.fields.IntegerField')(default=27), keep_default=False)

        # Adding field 'WifiNetworkConfig.pool'
        db.add_column('cgm_wifinetworkconfig', 'pool', self.gf('frontend.registry.fields.ModelSelectorKeyField')(default=1, to=orm['core.Pool']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WifiNetworkConfig.usage'
        db.delete_column('cgm_wifinetworkconfig', 'usage')

        # Deleting field 'WifiNetworkConfig.cidr'
        db.delete_column('cgm_wifinetworkconfig', 'cidr')
