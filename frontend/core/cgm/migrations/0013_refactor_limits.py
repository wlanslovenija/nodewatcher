...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InterfaceLimitConfig'
        db.create_table('cgm_interfacelimitconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(related_name='config_cgm_interfacelimitconfig', to=orm['nodes.Node'])),
            ('interface', self.gf('frontend.registry.fields.IntraRegistryForeignKey')(related_name='limits', to=orm['cgm.InterfaceConfig'])),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('cgm', ['InterfaceLimitConfig'])

        # Adding model 'ThroughputInterfaceLimitConfig'
        db.create_table('cgm_throughputinterfacelimitconfig', (
            ('interfacelimitconfig_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cgm.InterfaceLimitConfig'], unique=True, primary_key=True)),
            ('limit_out', self.gf('frontend.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
            ('limit_in', self.gf('frontend.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces.limits#speeds', blank=True)),
        ))
        db.send_create_signal('cgm', ['ThroughputInterfaceLimitConfig'])

        # Deleting field 'InterfaceConfig.limit_in'
        db.delete_column('cgm_interfaceconfig', 'limit_in')

        # Deleting field 'InterfaceConfig.limit_out'
        db.delete_column('cgm_interfaceconfig', 'limit_out')


    def backwards(self, orm):
        
        # Deleting model 'InterfaceLimitConfig'
        db.delete_table('cgm_interfacelimitconfig')

        # Deleting model 'ThroughputInterfaceLimitConfig'
        db.delete_table('cgm_throughputinterfacelimitconfig')

        # Adding field 'InterfaceConfig.limit_in'
        db.add_column('cgm_interfaceconfig', 'limit_in', self.gf('frontend.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)

        # Adding field 'InterfaceConfig.limit_out'
        db.add_column('cgm_interfaceconfig', 'limit_out', self.gf('frontend.registry.fields.SelectorKeyField')(default='', max_length=50, regpoint='node.config', enum_id='core.interfaces#traffic_limits', blank=True), keep_default=False)
