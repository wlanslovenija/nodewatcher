...
from frontend.registry import state as registry_state
from frontend.registry import models as registry_models
from frontend.registry import lookup as registry_lookup
from frontend.registry import access as registry_access
from frontend.utils import datastructures as nw_datastructures
...
def create_point(model, namespace):
  ...
  if point_id not in registry_state.points:
    ...
    item_base = type(
      ...
      {
        '__module__' : 'frontend.registry.models',
        'Meta' : Meta,
