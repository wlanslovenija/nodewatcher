...
from frontend.registry import rules as registry_rules
...
class RegistryMetaForm(forms.Form):
  ...
  """
  def __init__(self, context, selected_item = None, force_selector_widget = False, static = False,
    instance_mid = 0, *args, **kwargs):
    """
    Class constructor.
    """
